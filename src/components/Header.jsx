...
function Header() {
  return (
    <div>
      <div className='lg:w-[100%] sm:w-[648px] md:w-[768px] rounded-md bg-cyan-700 h-15 justify-center items-center flex gap-40'>
        <ul>
          <div className="flex p-5 items-center justify-between gap-20">
            ...
            <li className='block lg:hidden  md:hidden text-3xl'><IoMdMenu /></li>
          </div>
        </ul>
